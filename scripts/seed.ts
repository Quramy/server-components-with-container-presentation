...
import { ArtistFactory, AlbumFactory } from '../src/factories'
...
export async function main() {
  ...
  await ArtistFactory.create({
    ...
    albums: {
      create: await AlbumFactory.buildList([
        { name: 'Giant Steps', releaseYear: '1960' },
        { name: 'Coltrane Jazz', releaseYear: '1961' },
        { name: 'My Favorite Things', releaseYear: '1961' },
      ]),
    },
  })
}
